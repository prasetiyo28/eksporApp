...
class Udara extends StatefulWidget {
  @override
  _UdaraState createState() => _UdaraState();
}

class _UdaraState extends State<Udara> {
  @override
                                        ...
                                        children: <Widget>[
                                          ButtonTheme(
                                            ...
                                            child: RaisedButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context)=>TransGet(text:'U')));
                                              },
                                              child: Text(
                                                "Setuju",
                                                textAlign: TextAlign.center,
