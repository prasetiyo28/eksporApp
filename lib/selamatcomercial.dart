...
import 'package:ekspor_apps/shipping.dart';
import 'package:flutter/material.dart';
import 'dart:ui' as prefix0;

import 'mulai.dart';

class SelamatComercial extends StatefulWidget {
  @override
  _SelamatComercialState createState() => _SelamatComercialState();
}

class _SelamatComercialState extends State<SelamatComercial> {
  @override
          ...
          Container(
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    "Anda telah membuat Commercial Invoice",
