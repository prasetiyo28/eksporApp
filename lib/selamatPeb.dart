import 'package:ekspor_apps/beaCukai.dart';
...
class SelamatPeb extends StatefulWidget {
  @override
  _SelamatPebState createState() => _SelamatPebState();
}

class _SelamatPebState extends State<SelamatPeb> {
  @override
                  ...
                  Align(
                    ...
                    child: ButtonTheme(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>BeaCukai()));
                        },
                        child: Text(
                          "Ambil",
                          textAlign: TextAlign.center,
